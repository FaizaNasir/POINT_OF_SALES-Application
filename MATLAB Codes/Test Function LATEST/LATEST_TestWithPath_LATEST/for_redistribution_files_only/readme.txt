...
-LATEST_TestWithPath_LATEST.dll
   -contains the generated component using MWArray API. 
-LATEST_TestWithPath_LATESTNative.dll
...
LATEST_TestWithPath_LATEST_overview.html - HTML overview documentation file for the 
...
LATEST_TestWithPath_LATEST.xml - This file contains the code comments for the 
                                           LATEST_TestWithPath_LATEST component classes 
                                           ...
                                           LATEST_TestWithPath_LATEST component.
