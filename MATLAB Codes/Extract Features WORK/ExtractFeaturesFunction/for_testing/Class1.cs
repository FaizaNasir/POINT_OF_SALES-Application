...
namespace ExtractFeaturesFunction
{
  ...
  public class Class1 : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input MWArrayinterface to the ExtractFeaturesFunc
    /// MATLAB function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    ///
    public MWArray ExtractFeaturesFunc()
    {
      return mcr.EvaluateFunction("ExtractFeaturesFunc", new MWArray[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input MWArrayinterface to the ExtractFeaturesFunc
    /// MATLAB function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray ExtractFeaturesFunc(MWArray samples)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input MWArray interface to the ExtractFeaturesFunc MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// arguments.</returns>
    ///
    public MWArray[] ExtractFeaturesFunc(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "ExtractFeaturesFunc", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 1-input MWArray interface to the ExtractFeaturesFunc MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// arguments.</returns>
    ///
    public MWArray[] ExtractFeaturesFunc(int numArgsOut, MWArray samples)
    {
    ...
    ///
    public void ExtractFeaturesFunc(int numArgsOut, ref MWArray[] argsOut, MWArray[] 
                          argsIn)
    {
      mcr.EvaluateFunction("ExtractFeaturesFunc", numArgsOut, ref argsOut, argsIn);
    }
