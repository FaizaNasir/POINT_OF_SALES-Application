...
-ExtractFeaturesFunction.dll
   -contains the generated component using MWArray API. 
-ExtractFeaturesFunctionNative.dll
...
ExtractFeaturesFunction_overview.html - HTML overview documentation file for the 
                                        generated component. It contains the requirements 
                                        for accessing the component and for generating 
                                        arguments using the MWArray class hierarchy.

ExtractFeaturesFunction.xml - This file contains the code comments for the 
                                        ExtractFeaturesFunction component classes and 
                                        ...
                                        documentation for the ExtractFeaturesFunction 
                                        component.
