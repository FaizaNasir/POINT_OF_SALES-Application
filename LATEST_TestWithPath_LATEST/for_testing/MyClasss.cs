...
* Date: Fri May 06 21:26:59 2016
* Arguments: "-B" "macro_default" "-W"
* "dotnet:LATEST_TestWithPath_LATEST,MyClasss,0.0,private" "-T" "link:lib" "-d" "D:\FYP
* Work\NEW WORK\Ver 1.0-----10 Products\Test Function
* LATEST\LATEST_TestWithPath_LATEST\for_testing" "-v" "class{MyClasss:D:\FYP Work\NEW
* WORK\Ver 1.0-----10 Products\Test Function LATEST\test.m}" "-a" "D:\FYP Work\NEW
* WORK\Ver 1.0-----10 Products\Test Function LATEST\camerashot.wav" "-a"
...
namespace LATEST_TestWithPath_LATEST
{

  /// <summary>
  /// The MyClasss class provides a CLS compliant, MWArray interface to the MATLAB
  ...
  /// @Version 0.0
  /// </remarks>
  public class MyClasss : IDisposable
  {
    #region Constructors
    ...
    static MyClasss()
    {
      if (MWMCR.MCRAppInitialized)
      {
        try
        {
          ...
          string ctfFileName = "LATEST_TestWithPath_LATEST.ctf";
    ...
    /// <summary>
    /// Constructs a new instance of the MyClasss class.
    /// </summary>
    public MyClasss()
    {
      if(ex_ != null)
    ...
    /// <summary>
    /// Provides a single output, 1-input MWArrayinterface to the test MATLAB function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// imshow(image);                  to show image
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray test(MWArray path)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] test(int numArgsOut, MWArray path)
    {
